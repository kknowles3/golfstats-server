...
class PgaEventDataLoader():
    ...
    def __init__(self):
        ...
        self.__headers = { 
            ...
            # ':method': 'GET',
            # ':path': '/apis/v2/scoreboard/header?sport=golf&league=pga&region=us&lang=en&contentorigin=espn&buyWindow=1m&showAirings=buy%2Clive%2Creplay&showZipLookup=true&tz=America/New_York',
            # ':scheme': 'https',
