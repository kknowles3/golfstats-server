# -*- coding: utf-8 -*-
"""
Created on Thu Apr  8 17:46:59 2021
...
class PoolEventScorer():
    
    def __init__(self, mdl:MongoDataLoader, ref_datestr=None, dt_offset=None):
        '''
    ...
    def __initialize(self):
        ...
        self.pool_id_map = dict(zip(df['PoolName'], df[self.espn_id_col]))
        # self.id_pool_map = dict(zip(df.index.values, df['PoolName']))
        self.id_pool_map = dict(zip(df[self.espn_id_col], df['PoolName']))
