...
class NbkConverter():
    ...
    def convert_notebook_to_html(self, path_tag, fname_nbk, fname_md, template='basic', execute_nbk=False):
        ...
        try:
            ...
            if execute_nbk:
                cmd = 'jupyter nbconvert "{}{}" --no-input --to html --execute --output {} --template {}'.format(path_tag, fname_nbk, fname_md, template)
            else:
                cmd = 'jupyter nbconvert "{}{}" --no-input --to html --output {} --template {}'.format(path_tag, fname_nbk, fname_md, template)
    ...
    def convert_notebook_to_markdown(self, path_tag, fname_nbk, fname_md, template='basic', execute_nbk=False):
        ...
        # Convert to html
        self.convert_notebook_to_html(path_tag, fname_nbk, fname_md, template, execute_nbk)
    ...
    def convert_notebook_by_config(self, config_data, template='basic', execute_nbk=False, copy_to_dest=True):
        ...
        fname_md = config_data.get("fname_md")
        
        self.convert_notebook_to_markdown(path_tag=local_path_tag, fname_nbk=fname_nbk, fname_md=fname_md, execute_nbk=execute_nbk)
        ...
        if copy_to_dest:            
            ...
            self.prepend_header_text(local_path_tag, fname_md, hdr_props)
            self.copy_file(local_path_tag, fname_md, dest_path_tag)
