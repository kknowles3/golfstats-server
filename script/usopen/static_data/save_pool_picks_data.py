...
team_picks_path = os.path.join(APP_PATH, 'data/usopen')
# ********* Update with actual picks once they are available
team_picks_fname = '2021 US Open Pool Selections_edit.csv'
team_picks_skip_rows = 3 # Number of import rows to skip
db_name = 'usopen2021'
