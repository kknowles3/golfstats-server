...
if __name__ == "__main__":
    ...
    ##########################################
    # Get data using the legacy soup approach
    ##########################################
    ...
    ###################################
    # Get data using the json approach    
    ###################################
    ...
    # roster_cols = [col for col in roster_cols if col in athletes_df.columns.values]
    # roster_df2 = athletes_df[roster_cols]
